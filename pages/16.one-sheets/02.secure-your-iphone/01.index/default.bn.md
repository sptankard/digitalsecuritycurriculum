		...
		<div id="carouselslide" class="carousel slide" data-ride="carousel" data-interval="false">
		  ...
		  <div class="carousel-inner" role="listbox">
			...
			<div style="display: table-cell; width: 540px;">
		           ...
		           <iframe id="page1" width="540" height="540"  src="http://digitalsecurityforall.com/bn/one-sheets/secure-your-iphone/page1" frameborder="0" allowfullscreen></iframe> 
                        </div>
                    </div>
			...
			<div style="display: table-cell; width: 540px;">
		           ...
		           <iframe id="page1" width="540" height="540"  src="http://digitalsecurityforall.com/bn/one-sheets/secure-your-iphone/page2" frameborder="0" allowfullscreen></iframe> 
                        </div>
		    </div>
			...
			<div style="display: table-cell; width: 540px;">
		           ...
		           <iframe id="page1" width="540" height="540"  src="http://digitalsecurityforall.com/bn/one-sheets/secure-your-iphone/page3" frameborder="0" allowfullscreen></iframe> 
                        </div>
